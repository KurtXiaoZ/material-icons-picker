...
import { COLOR_SELECTOR_CONTAINER_BASE_STYLE, COLOR_SELECTED_INDICATOR_BASE_STYLE, COLOR_SELECTED_BASE_STYLE, COLOR_SELECTOR_ARROW_BASE_STYLE, PALATTE_CONTAINER_BASE_STYLE, SATURATION_BASE_STYLE, HUE_BASE_STYLE } from "./styles";
...
export const ColorSelector = (props: IColorSelector = {}) => {
    ...
    useEventOutside('mousedown', [colorSelectorContainerRef, paletteContainerRef], () => setShowPaletteContainer(false));
    ...
    >
        <span
            style={colorSelectedIndicator 
                ? colorSelectedIndicator(COLOR_SELECTED_INDICATOR_BASE_STYLE({ color: hsvaToHex(hsva) })) 
                : COLOR_SELECTED_INDICATOR_BASE_STYLE({ color: hsvaToHex(hsva) })}
        ></span>
        <span
        ...
        <img
            src={ArrowDownIcon}
            style={colorSelectorArrow ? colorSelectorArrow(COLOR_SELECTOR_ARROW_BASE_STYLE) : COLOR_SELECTOR_ARROW_BASE_STYLE}
        />
        {showPaletteContainer && <div
            style={palatteContainer
                ? palatteContainer(PALATTE_CONTAINER_BASE_STYLE({ colorContainerHeight, colorContainerWidth }))
                : PALATTE_CONTAINER_BASE_STYLE({ colorContainerHeight, colorContainerWidth })
            }
